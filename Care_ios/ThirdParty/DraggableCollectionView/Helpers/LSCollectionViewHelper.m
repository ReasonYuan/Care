...
//             completion:nil];
            ...
            shake.fromValue = [NSValue valueWithCATransform3D:CATransform3DRotate(mockCell.layer.transform,-rotation, 0.0 ,0.0 ,1.0)];
            shake.toValue   = [NSValue valueWithCATransform3D:CATransform3DRotate(mockCell.layer.transform, rotation, 0.0 ,0.0 ,1.0)];
            [mockCell.layer addAnimation:shake forKey:@"shakeAnimation"];
