...
- (UIView *)createContainerView
{
    ...
    dialogContainer.layer.borderColor = [UIColor colorWithRed:53/255.0f green:56/255.0f blue:66/255.0f alpha:1].CGColor;
...
//    dialogContainer.backgroundColor = [UIColor colorWithRed:53/255.0f green:56/255.0f blue:66/255.0f alpha:1];
    containerView.backgroundColor = [UIColor colorWithRed:48/255.0f green:53/255.0f blue:63/255.0f alpha:1];
