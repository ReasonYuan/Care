...
-(void)reloadData{
    ...
    NSEnumerator *enumerator = [_onShowViewDictionary keyEnumerator];
    id key;
    while ((key = [enumerator nextObject])) {
        [_reusableViewSet addObject:[_onShowViewDictionary objectForKey:key]];
    }
...
-(void)scrollViewToIndex:(int)index{
    ...
    [self setPageToPositionIndex:index];
}
